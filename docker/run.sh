...
docker run -it --rm --net=host --gpus all -e DISPLAY=$DISPLAY -e ROS_DOMAIN_ID=88 -v /tmp/.X11-unix/:/tmp/.X11-unix \
-v ${MAP_PATH}:/autoware_map ghcr.io/autowarefoundation/autoware-openadkv3:monolithic-humble-latest--cuda \
